...
func TestCreateMyStylistService_CreateMyStylist_Success(t *testing.T) {
	env := setup.SetupTestEnvironmentForService(t)
	defer env.Cleanup()

	mockQuerier := mocks.NewMockQuerier()
	service := NewCreateMyStylistService(mockQuerier)
	...
	response, err := service.CreateMyStylist(ctx, req, staffUserID)
...
func TestCreateMyStylistService_CreateMyStylist_AlreadyExists(t *testing.T) {
	env := setup.SetupTestEnvironmentForService(t)
	defer env.Cleanup()
...
func TestCreateMyStylistService_CreateMyStylist_DatabaseError(t *testing.T) {
	env := setup.SetupTestEnvironmentForService(t)
	defer env.Cleanup()
...
func TestCreateMyStylistService_CreateMyStylist_WithDefaults(t *testing.T) {
	env := setup.SetupTestEnvironmentForService(t)
	defer env.Cleanup()
