...
type DeleteTimeSlotTemplateItemServiceInterface interface {
	DeleteTimeSlotTemplateItem(ctx context.Context, templateID string, itemID string, staffContext common.StaffContext) (*schedule.DeleteTimeSlotTemplateItemResponse, error)
}
...
func (s *DeleteTimeSlotTemplateItemService) DeleteTimeSlotTemplateItem(ctx context.Context, templateID string, itemID string, staffContext common.StaffContext) (*schedule.DeleteTimeSlotTemplateItemResponse, error) {
	// Parse template ID
	...
	return &schedule.DeleteTimeSlotTemplateItemResponse{
