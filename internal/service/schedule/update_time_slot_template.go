...
type UpdateTimeSlotTemplateServiceInterface interface {
	UpdateTimeSlotTemplate(ctx context.Context, templateID string, req schedule.UpdateTimeSlotTemplateRequest, staffContext common.StaffContext) (*schedule.UpdateTimeSlotTemplateResponse, error)
}
...
func (s *UpdateTimeSlotTemplateService) UpdateTimeSlotTemplate(ctx context.Context, templateID string, req schedule.UpdateTimeSlotTemplateRequest, staffContext common.StaffContext) (*schedule.UpdateTimeSlotTemplateResponse, error) {
