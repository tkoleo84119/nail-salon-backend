...
type UpdateTimeSlotTemplateItemServiceInterface interface {
	UpdateTimeSlotTemplateItem(ctx context.Context, templateID string, itemID string, req schedule.UpdateTimeSlotTemplateItemRequest, staffContext common.StaffContext) (*schedule.UpdateTimeSlotTemplateItemResponse, error)
}
...
func (s *UpdateTimeSlotTemplateItemService) UpdateTimeSlotTemplateItem(ctx context.Context, templateID string, itemID string, req schedule.UpdateTimeSlotTemplateItemRequest, staffContext common.StaffContext) (*schedule.UpdateTimeSlotTemplateItemResponse, error) {
	// Parse template ID
	...
	return &schedule.UpdateTimeSlotTemplateItemResponse{
