...
type CreateTimeSlotTemplateItemServiceInterface interface {
	CreateTimeSlotTemplateItem(ctx context.Context, templateID string, req schedule.CreateTimeSlotTemplateItemRequest, staffContext common.StaffContext) (*schedule.CreateTimeSlotTemplateItemResponse, error)
}
...
func (s *CreateTimeSlotTemplateItemService) CreateTimeSlotTemplateItem(ctx context.Context, templateID string, req schedule.CreateTimeSlotTemplateItemRequest, staffContext common.StaffContext) (*schedule.CreateTimeSlotTemplateItemResponse, error) {
	// Parse template ID
	...
	return &schedule.CreateTimeSlotTemplateItemResponse{
