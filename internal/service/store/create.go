...
func (s *CreateStoreService) CreateStore(ctx context.Context, req store.CreateStoreRequest, staffContext common.StaffContext) (*store.CreateStoreResponse, error) {
	// Parse staff user ID
