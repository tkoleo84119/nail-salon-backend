...
func (s *CreateTimeSlotTemplateService) CreateTimeSlotTemplate(ctx context.Context, req adminTimeSlotTemplateModel.CreateTimeSlotTemplateRequest, staffContext common.StaffContext) (*adminTimeSlotTemplateModel.CreateTimeSlotTemplateResponse, error) {
	// Parse staff user ID
	...
	responseTimeSlots := make([]adminTimeSlotTemplateModel.TimeSlotItemResponse, len(req.TimeSlots))
	...
	for i, timeSlot := range req.TimeSlots {
		...
		responseTimeSlots[i] = adminTimeSlotTemplateModel.TimeSlotItemResponse{
	...
	return &adminTimeSlotTemplateModel.CreateTimeSlotTemplateResponse{
...
func (s *CreateTimeSlotTemplateService) validateTimeSlots(timeSlots []adminTimeSlotTemplateModel.TimeSlotItem) error {
	if len(timeSlots) == 0 {
