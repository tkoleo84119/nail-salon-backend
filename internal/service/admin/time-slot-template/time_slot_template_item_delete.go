...
func (s *DeleteTimeSlotTemplateItemService) DeleteTimeSlotTemplateItem(ctx context.Context, templateID string, itemID string, staffContext common.StaffContext) (*adminTimeSlotTemplateModel.DeleteTimeSlotTemplateItemResponse, error) {
	// Parse template ID
	...
	return &adminTimeSlotTemplateModel.DeleteTimeSlotTemplateItemResponse{
		Deleted: itemID,
	}, nil
}
