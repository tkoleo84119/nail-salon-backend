...
func (s *CreateTimeSlotService) CreateTimeSlot(ctx context.Context, scheduleID string, req adminScheduleModel.CreateTimeSlotRequest, staffContext common.StaffContext) (*adminScheduleModel.CreateTimeSlotResponse, error) {
	// Parse schedule ID
	...
	// Build response
	response := &adminScheduleModel.CreateTimeSlotResponse{
