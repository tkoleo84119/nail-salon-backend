...
func (s *CreateMyStylistService) CreateMyStylist(ctx context.Context, req adminStylistModel.CreateMyStylistRequest, staffUserID int64) (*adminStylistModel.CreateMyStylistResponse, error) {
	...
	// Build response
	response := &adminStylistModel.CreateMyStylistResponse{
