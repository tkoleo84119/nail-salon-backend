...
type Repositories struct {
	...
	StaffUserStoreAccess *StaffUserStoreAccessRepository
	StaffUserTokens      *StaffUserTokensRepository
...
func NewRepositories(db *sqlx.DB) *Repositories {
	return &Repositories{
		...
		StaffUserStoreAccess: NewStaffUserStoreAccessRepository(db),
		StaffUserTokens:      NewStaffUserTokensRepository(db),
