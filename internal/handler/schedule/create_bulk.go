...
type CreateSchedulesBulkHandler struct {
	service scheduleService.CreateSchedulesBulkServiceInterface
}

func NewCreateSchedulesBulkHandler(service scheduleService.CreateSchedulesBulkServiceInterface) *CreateSchedulesBulkHandler {
...
func (h *CreateSchedulesBulkHandler) CreateSchedulesBulk(c *gin.Context) {
	...
	var req schedule.CreateSchedulesBulkRequest
