...
type DeleteTimeSlotTemplateItemHandler struct {
	service scheduleService.DeleteTimeSlotTemplateItemServiceInterface
}

func NewDeleteTimeSlotTemplateItemHandler(service scheduleService.DeleteTimeSlotTemplateItemServiceInterface) *DeleteTimeSlotTemplateItemHandler {
