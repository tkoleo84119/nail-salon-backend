...
var _ scheduleService.CreateTimeSlotTemplateItemServiceInterface = (*MockCreateTimeSlotTemplateItemService)(nil)

func (m *MockCreateTimeSlotTemplateItemService) CreateTimeSlotTemplateItem(ctx context.Context, templateID string, req schedule.CreateTimeSlotTemplateItemRequest, staffContext common.StaffContext) (*schedule.CreateTimeSlotTemplateItemResponse, error) {
	args := m.Called(ctx, templateID, req, staffContext)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*schedule.CreateTimeSlotTemplateItemResponse), args.Error(1)
}
...
func TestCreateTimeSlotTemplateItemHandler_CreateTimeSlotTemplateItem_Success(t *testing.T) {
	...
	expectedResponse := &schedule.CreateTimeSlotTemplateItemResponse{
		ID:         "6100000003",
	...
	mockService.On("CreateTimeSlotTemplateItem", mock.Anything, "6000000011", mock.AnythingOfType("schedule.CreateTimeSlotTemplateItemRequest"), mock.AnythingOfType("common.StaffContext")).Return(expectedResponse, nil)

	// Create request
	createReq := schedule.CreateTimeSlotTemplateItemRequest{
		StartTime: "10:00",
		EndTime:   "13:00",
	}
...
func TestCreateTimeSlotTemplateItemHandler_CreateTimeSlotTemplateItem_PermissionDenied(t *testing.T) {
	...
	mockService.On("CreateTimeSlotTemplateItem", mock.Anything, "6000000011", mock.AnythingOfType("schedule.CreateTimeSlotTemplateItemRequest"), mock.AnythingOfType("common.StaffContext")).Return(nil, serviceError)
...
func TestCreateTimeSlotTemplateItemHandler_CreateTimeSlotTemplateItem_InternalError(t *testing.T) {
	...
	mockService.On("CreateTimeSlotTemplateItem", mock.Anything, "6000000011", mock.AnythingOfType("schedule.CreateTimeSlotTemplateItemRequest"), mock.AnythingOfType("common.StaffContext")).Return(nil, internalError)
