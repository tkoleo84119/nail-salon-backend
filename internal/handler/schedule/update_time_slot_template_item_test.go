...
func (m *MockUpdateTimeSlotTemplateItemService) UpdateTimeSlotTemplateItem(ctx context.Context, templateID string, itemID string, req schedule.UpdateTimeSlotTemplateItemRequest, staffContext common.StaffContext) (*schedule.UpdateTimeSlotTemplateItemResponse, error) {
	args := m.Called(ctx, templateID, itemID, req, staffContext)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*schedule.UpdateTimeSlotTemplateItemResponse), args.Error(1)
}
...
func TestUpdateTimeSlotTemplateItemHandler_UpdateTimeSlotTemplateItem_Success(t *testing.T) {
	...
	expectedResponse := &schedule.UpdateTimeSlotTemplateItemResponse{
		ID:         "6100000003",
