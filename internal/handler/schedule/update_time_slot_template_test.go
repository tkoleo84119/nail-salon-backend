...
var _ scheduleService.UpdateTimeSlotTemplateServiceInterface = (*MockUpdateTimeSlotTemplateService)(nil)

func (m *MockUpdateTimeSlotTemplateService) UpdateTimeSlotTemplate(ctx context.Context, templateID string, req schedule.UpdateTimeSlotTemplateRequest, staffContext common.StaffContext) (*schedule.UpdateTimeSlotTemplateResponse, error) {
...
func TestUpdateTimeSlotTemplateHandler_UpdateTimeSlotTemplate_Success(t *testing.T) {
	...
	note := "Updated note"
	expectedResponse := &schedule.UpdateTimeSlotTemplateResponse{
		ID:   "6000000011",
		Name: "Updated Template",
		Note: "Updated note",
	}

	mockService.On("UpdateTimeSlotTemplate", mock.Anything, "6000000011", mock.AnythingOfType("schedule.UpdateTimeSlotTemplateRequest"), mock.AnythingOfType("common.StaffContext")).Return(expectedResponse, nil)

	// Create request
	updateReq := schedule.UpdateTimeSlotTemplateRequest{
		Name: &name,
		Note: &note,
	}
...
func TestUpdateTimeSlotTemplateHandler_UpdateTimeSlotTemplate_ValidationError(t *testing.T) {
	...
	mockService.On("UpdateTimeSlotTemplate", mock.Anything, "6000000011", mock.AnythingOfType("schedule.UpdateTimeSlotTemplateRequest"), mock.AnythingOfType("common.StaffContext")).Return(nil, serviceError)
...
func TestUpdateTimeSlotTemplateHandler_UpdateTimeSlotTemplate_InternalError(t *testing.T) {
	...
	mockService.On("UpdateTimeSlotTemplate", mock.Anything, "6000000011", mock.AnythingOfType("schedule.UpdateTimeSlotTemplateRequest"), mock.AnythingOfType("common.StaffContext")).Return(nil, internalError)
