...
type UpdateTimeSlotTemplateHandler struct {
	service scheduleService.UpdateTimeSlotTemplateServiceInterface
}

func NewUpdateTimeSlotTemplateHandler(service scheduleService.UpdateTimeSlotTemplateServiceInterface) *UpdateTimeSlotTemplateHandler {
...
func (h *UpdateTimeSlotTemplateHandler) UpdateTimeSlotTemplate(c *gin.Context) {
	...
	var req scheduleModel.UpdateTimeSlotTemplateRequest
