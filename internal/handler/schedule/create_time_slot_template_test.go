...
func TestNewCreateTimeSlotTemplateHandler(t *testing.T) {
	...
	service := scheduleService.NewCreateTimeSlotTemplateService(mockQuerier, nil)
...
func (m *MockCreateTimeSlotTemplateService) CreateTimeSlotTemplate(ctx context.Context, req schedule.CreateTimeSlotTemplateRequest, staffContext common.StaffContext) (*schedule.CreateTimeSlotTemplateResponse, error) {
	args := m.Called(ctx, req, staffContext)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*schedule.CreateTimeSlotTemplateResponse), args.Error(1)
}
...
func TestCreateTimeSlotTemplateHandler_CreateTimeSlotTemplate_ServiceError(t *testing.T) {
	...
	expectedRequest := schedule.CreateTimeSlotTemplateRequest{
		Name: "Test Template",
...
func TestCreateTimeSlotTemplateHandler_CreateTimeSlotTemplate_Success(t *testing.T) {
	...
	expectedResponse := &schedule.CreateTimeSlotTemplateResponse{
		ID:   "6000000001",
		Name: "Test Template",
		Note: "Test note",
		TimeSlots: []schedule.TimeSlotItemResponse{
