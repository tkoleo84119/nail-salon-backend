...
type DeleteTimeSlotHandler struct {
	service adminScheduleService.DeleteTimeSlotServiceInterface
}

func NewDeleteTimeSlotHandler(service adminScheduleService.DeleteTimeSlotServiceInterface) *DeleteTimeSlotHandler {
