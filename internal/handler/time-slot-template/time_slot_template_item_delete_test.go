...
func (m *MockDeleteTimeSlotTemplateItemService) DeleteTimeSlotTemplateItem(ctx context.Context, templateID string, itemID string, staffContext common.StaffContext) (*timeSlotTemplate.DeleteTimeSlotTemplateItemResponse, error) {
	args := m.Called(ctx, templateID, itemID, staffContext)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*timeSlotTemplate.DeleteTimeSlotTemplateItemResponse), args.Error(1)
}
...
func TestDeleteTimeSlotTemplateItemHandler_DeleteTimeSlotTemplateItem_Success(t *testing.T) {
	...
	expectedResponse := &timeSlotTemplate.DeleteTimeSlotTemplateItemResponse{
